...
.Descrption
	...
	This script will download the CornHub image and the CornHub Intro sound effect 	hosted with this payload and host volume will be raised to max level
	...
	After a mouse movement is detected their wallpaper will change to the CornHub 	image provided and the Intro sound effect will play
#>
...
$image = https://github.com/Zen-ith1/HornHub/blob/main/Hornhub.png.png
$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://github.com/Zen-ith1/HornHub/blob/main/Hornhub.png.png?dl=1 -O $env:TMP\i.png

# Download WAV file; replace link to $wav to add your own sound

$wav = https://github.com/Zen-ith1/HornHub/blob/main/HornHub.wav.wav?raw=true"
